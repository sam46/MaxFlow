...
public class FordFulkerson {
    ...
    private FFEdge[] edgeTo;    // edgeTo[v] = last edge on shortest residual s->v path
     ...
     */
    public FordFulkerson(FFFlowNetwork G, int s, int t) {
        V = G.V();
        validate(s);
        validate(t);
...
//        }
     ...
     * @param  s the source vertex
     * @param  t the sink vertex
     * @return false if no more steps are needed
     */
    public boolean step(FFFlowNetwork G, int s, int t) {
        if(!hasAugmentingPath(G, s, t))
            return false;
    ...
    private boolean hasAugmentingPath(FFFlowNetwork G, int s, int t) {
        edgeTo = new FFEdge[G.V()];
    ...
    private double excess(FFFlowNetwork G, int v) {
        double excess = 0.0;
        for (FFEdge e : G.adj(v)) {
    ...
    // return excess flow at vertex v
    private boolean isFeasible(FFFlowNetwork G, int s, int t) {
    ...
    // check optimality conditions
    private boolean check(FFFlowNetwork G, int s, int t) {
...
//        int s = 0, t = V-1;
//        FFFlowNetwork G = new FFFlowNetwork(V, E);
//        System.out.println(G);
//
//        // compute maximum flow and minimum cut
//        FordFulkerson com.bbot.maxflow = new FordFulkerson(G, s, t);
...
//        for (int v = 0; v < G.V(); v++) {
//            if (com.bbot.maxflow.inCut(v)) System.out.print(v + " ");
//        }
//        System.out.println();
//
//        System.out.println("Max flow value = " +  com.bbot.maxflow.value());
//    }
